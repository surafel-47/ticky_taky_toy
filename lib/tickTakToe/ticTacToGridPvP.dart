...
class TicTakToeGridPvP extends StatefulWidget {
  bool isRobot;
  TicTakToeGridPvP({this.isRobot = false});
  @override
  State<TicTakToeGridPvP> createState() => _TicTakToeGridState();
}

class _TicTakToeGridState extends State<TicTakToeGridPvP> {
  @override
  void initState() {
    super.initState();
    resetTwoDArray();
      ...
      onTap: () {
        ...
        if (!isMarked) {
          if (isPlayerOne) {
            ...
            isMarked = true;
            isPlayerOne = true;
            gridColor = Color.fromARGB(255, 30, 28, 193).withOpacity(0.3);
